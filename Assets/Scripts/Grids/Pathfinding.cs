...
public class Pathfinding
{
    ...
    private int MOVE_DOWN_COST = 200;
    private int MOVE_DIAGONAL_COST = 14000;
    ...
    public List<Vector3> FindPath(Vector3 startWorldPosition, Vector3 endWorldPosition)
    {
        ...
        else
        {
            ...
            {
                vectorPath.Add((new Vector3(pathNode.x, pathNode.y) * grid.GetCellSize() + Vector3.one * grid.GetCellSize() * 0.5f) + origin);
            }
            return vectorPath;
        }
    }
    ...
    private int CalculateDistanceCost(PathNode a, PathNode b)
    {
        ...
        return MOVE_STRAIGHT_COST * xDistance + MOVE_DOWN_COST * yDistance;
    }
